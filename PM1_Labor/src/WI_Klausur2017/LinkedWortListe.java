...
public class LinkedWortListe
{
    ...
    {
        // Todo: implementieren fuer Aufgabe 4
        DoppellinkKnoten a = _listenkopf;
        DoppellinkKnoten b = _listenende;
        _listenende = _listenkopf;
        _listenkopf = b;
        for(int i = 1; i<= _anzahlWoerter +2 ; i++)
        {
            DoppellinkKnoten teilNachfolger = a.gibNachfolger();
            a.setzeNachfolger(a.gibVorgaenger());
            a.setzeVorgaenger(teilNachfolger);
            a=a.gibVorgaenger();
